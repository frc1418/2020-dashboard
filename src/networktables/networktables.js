...
var NetworkTables =
    (() => {
        ...
        return {
            ...
            /**
             * Removes a robot connection listener from the list of active ones.
             * @param {(connected: boolean) => any} f The callback function that is currently active as a listener
             */
            removeRobotConnectionListener(f) {
                if(typeof f != 'function') return new Error('Invalid argument')

                connectionListeners.splice(connectionListeners.indexOf(f), 1);
            },
            /**
